...
export const devicePrefixes80Series = [
  { "id": "16 - Cylinder Dogging", "description": "Keyed Cylinder at the end of the rail which 'dogs' the device down (meaning it is held open)", "addsCylinder": { "partNumber": "#41", "type": "Mortise Cylinder" }, "addsCollar": { "partNumber": "97-Rosette", "description": "Rosette for 16- Cylinder Dogging" }, "isDeviceSpecific": true, "keywords": [] },
...
export const devicePrefixesPE80Series = [
  { "id": "16", "description": "Cylinder Dogging", "addsCylinder": { "partNumber": "#41", "type": "Mortise Cylinder" }, "addsCollar": { "partNumber": "97-Rosette", "description": "Rosette for 16- Cylinder Dogging" }, "isDeviceSpecific": true, "keywords": [] },
